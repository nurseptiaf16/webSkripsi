...
<div style="max-width: 900px;">
    <div style="margin-bottom: 20px; display: flex; align-items: center; justify-content: space-between; gap: 12px; flex-wrap: wrap;">
        <div>
            <h1 style="font-size: 22px; font-weight: 700; color: var(--color-text); margin-bottom: 6px;">Edit Profil</h1>
            <div style="font-size: 13px; color: var(--color-text-muted);">Perbarui nama dan email akun Anda.</div>
        </div>
